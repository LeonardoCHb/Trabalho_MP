...
TEST_CASE("Deve retornar -1 caso os caracteres se repitam mais de tres vezes SEGUIDAS", "ConverteArabico") {
...
TEST_CASE("Letras devem ser somadas ou subtraidas dependendo do valor da letra maior adjacente", "ConverteArabico") {
...
TEST_CASE("Deve retornar o numero decimal correspondente ao numero romano", "ConverteArabico") {
